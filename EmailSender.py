...
def sendEmailTranscriptAnalyser(userEmailAddress, course):
    msg = EmailMessage()

    message = """\
    This message is to inform you that a new grade was added on your transcript for the course : """ + course + """. 
